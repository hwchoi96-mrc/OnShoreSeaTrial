      ...
      <div class="tab-container">
        <div class="shipInfo-container d-flex flex-wrap ga-2">
          <div class="shipInfo-item">
            ...
            <i-input
              label="선박명"
              type="text"
              v-model="shipEditForm.name"
              placeholder="선박명을 입력하여 주십시오"
              required
              :hide-details="false"
            >
            </i-input>
          ...
          <div class="shipInfo-item">
            ...
            <v-autocomplete
              v-model="shipEditForm.nation"
              :items="ports"
              item-title="name"
              item-value="code"
              density="compact"
              bg-color="#434348"
              placeholder="Flag를 선택하세요"
              hide-details
              variant="solo-filled"
          ...
          <div class="shipInfo-item">
            ...
            <i-input
              label="IMO Number"
              type="text"
              v-model="shipEditForm.imoNumber"
              placeholder="IMONumber 입력하여 주십시오"
              maxChar="7"
              maxlength="7"
              required
              :hide-details="false"
          ...
          <div class="shipInfo-item">
            ...
            <i-input
              ...
              type="text"
              :maxChar="9"
              v-model="shipEditForm.mmsiNumber"
              placeholder="MMSI를 입력하여 주십시오"
              maxlength="9"
              required
              :hide-details="false"
            >
          ...
          <div class="shipInfo-item">
            ...
            <i-input
              ...
              type="text"
              :maxlength="7"
              v-model="shipEditForm.callSign"
              placeholder="CallSign을 입력하여 주십시오"
              required
              :hide-details="false"
            >
            </i-input>
        ...
        <div class="shipParticulars-container d-flex flex-wrap ga-2">
          <div class="shipInfo-item">
            ...
            <v-autocomplete
              v-model="shipEditForm.type"
              :items="shipTypes"
              density="compact"
              bg-color="#434348"
              variant="solo-filled"
              placeholder="Type을 선택하여 주십시오"
              no-data-text="데이터가 없습니다"
              hide-details
            />
          </div>
          <div class="shipInfo-item">
            ...
            <i-input
              label="Flag"
              type="number"
              v-model="shipEditForm.length"
              placeholder="Length를 입력하여 주십시오"
              required
              :hide-details="false"
            ></i-input>
          </div>
          <div class="shipInfo-item">
            ...
            <i-input
              label="Gross Tonnage"
              type="number"
              v-model="shipEditForm.grossTonnage"
              placeholder="Gross Tonnage를 입력하여 주십시오"
              required
              :hide-details="false"
            >
            </i-input>
          ...
          <div class="shipInfo-item">
            ...
            <i-input
              label="Beam"
              type="number"
              v-model="shipEditForm.beam"
              placeholder="Beam을 입력하여 주십시오"
              required
              :hide-details="false"
            >
            </i-input>
          ...
          <div class="shipInfo-item">
            ...
            <i-input
              label="Summer Dwt"
              type="number"
              v-model="shipEditForm.summerDwt"
              placeholder="Summer Dwt를 입력하여 주십시오"
              required
              :hide-details="false"
            >
            </i-input>
          ...
          <div class="shipInfo-item">
            ...
            <i-input
              label="Year Built"
              type="text"
              v-model="shipEditForm.yearBuilt"
              placeholder="Year Built를 입력하여 주십시오"
              maxlength="4"
              required
              :hide-details="false"
            >
...
const emit = defineEmits(['updateShipInfo', 'changeComponent'])
...
const fetchShipInformation = async () => {
  ...
  originShipName = shipEditForm.value.name
}
...
const editShipInfo = async () => {
  ...
  let shipNameInfo = {
    originShipName: originShipName,
    newShipName: shipEditForm.value.name
  }
  emit('updateShipInfo', shipNameInfo)
  originShipName = shipEditForm.value.name
}
...
watch(
  ...
  () => {
    ...
    emit('changeComponent', 'NoSelectShip')
  }
)
</script>
