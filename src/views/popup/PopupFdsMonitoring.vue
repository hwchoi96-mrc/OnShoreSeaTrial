<template>
  <v-sheet class="ma-3 py-3 rounded-lg detail-page fds-container">
    <v-sheet class="mx-3 px-3 py-3 mb-3 rounded-lg" color="#333334">
    ...
    <v-sheet
      ...
      class="deck-image-container d-flex justify-center mx-3 py-4 mb-4"
    ...
    <v-sheet class="px-3" :class="isExistDeckImage ? 'image-grid-container' : 'full-container'">
      <DxDataGrid
...
.image-grid-container {
  height: 100%;
  max-height: calc(100% - 60px - 300px - 24px);
}
